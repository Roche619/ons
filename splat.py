...
with streamlit_analytics.track():
    ...
    if image_file is not None:
        ...
        if effect == "Reflect on Diagonal":
            ...
            st.text("There is a race condition bug that needs sorting. If you get an error, just make a")
            st.text("selection of any of the values and the processing will continue okay.")
